...
const UpcomingAndInProgressTests = () => {
  ...
  return (
    ...
    >
      <GridItem
        ...
        gridColumn={{ lg: '1/2' }}
      >
        <Text textStyle='h2' color='blue.700' mr={{ lg: 20 }}>
          Upcoming & In-Progress In-Person Tests
        </Text>
      </GridItem>
      {!isEmpty ? (
        <StyledSwiper
...
export default UpcomingAndInProgressTests;
